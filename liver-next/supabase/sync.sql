...
-- [sync] one-time data migration removed: insert into public.event_types (key, name, description) valu
...
-- [sync] one-time data migration removed: update public.guests_rsvp set event_id = (
...
-- [sync] one-time data migration removed: update public.tables_seating set event_id = (
...
-- [sync] one-time data migration removed: update public.day_schedule set event_id = (
...
-- [sync] one-time data migration removed: update public.budget_items set event_id = (
...
-- [sync] one-time data migration removed: update public.venue_comparisons set event_id = (
...
-- [sync] one-time data migration removed: insert into public.task_templates (event_type, title, descri
...
-- [sync] one-time data migration removed: update public.tasks t set event_id = (

-- [sync] one-time data migration removed: update public.guests_rsvp g set event_id = (

-- [sync] one-time data migration removed: update public.tables_seating s set event_id = (

-- [sync] one-time data migration removed: update public.day_schedule d set event_id = (

-- [sync] one-time data migration removed: update public.budget_items b set event_id = (

-- [sync] one-time data migration removed: update public.venue_comparisons v set event_id = (
...
-- [sync] one-time data migration removed: update public.tasks t
...
-- [sync] one-time data migration removed: update public.clients set budget_visible = true where budget
...
-- [sync] one-time data migration removed: insert into public.event_vendors (client_id, name, category,
...
-- [sync] one-time data migration removed: update public.forum_posts fp

-- [sync] one-time data migration removed: update public.forum_comments fc
