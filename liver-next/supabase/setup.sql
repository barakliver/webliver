...
--
--  Paste this whole file into the Supabase SQL Editor of a NEW project and
--  press Run, once. It is 0001_init.sql followed by 0002_auth_bootstrap.sql,
--  in that order, so there is nothing to get wrong about which runs first.
--
--  Running it twice is harmless: every object is created with "if not exists"
