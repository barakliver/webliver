...
import { BookOpen, CalendarDays, Ellipsis, Globe, HeartHandshake, LayoutGrid, Palette, ShieldCheck, Sparkles, Store, Target, TrendingUp, Truck, X, type LucideIcon } from 'lucide-react';
import { cn } from '@/lib/utils';
import { appCopy } from '@/content/site';

export type NavItem = { href: string; label: string; icon: IconName };
export type IconName = 'overview' | 'leads' | 'clients' | 'calendar' | 'insights' | 'brand' | 'vendors' | 'store' | 'sop' | 'site' | 'admin' | 'portal';
