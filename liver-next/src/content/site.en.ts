...
export const siteEn: SiteCopy = {
  ...
  lead: {
    ...
    fields: {
      ...
      location: 'Event location / preferred region',
    },
    locationFree: 'Or the venue, if you have one',
    ...
    errors: {
      ...
      guestsMax: 'The most we can take is {max} guests',
      saveFailed: 'We could not save your enquiry. Please try again, or send us a message on WhatsApp.',
    },
    regions: ['Center', 'Sharon', 'North', 'South', 'Jerusalem area', 'Outdoor / open ground'],
    submit: 'Send',
    sending: 'Sending',
