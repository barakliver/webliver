...
export const site: SiteCopy = {
  ...
  hero: {
    ...
    name: 'ברק ליור',
    body: [
      'ערב אחד בחיים, כל האנשים היקרים לכם נמצאים במקום אחד.',
      'ערב כזה ראוי שילווה אותו מי שמכיר את הדרך.',
      'מהפגישה הראשונה ועד השיר האחרון, אנחנו מלווים את התכנון, התקציב, הספקים וכל פרט קטן שבדרך.',
      'אתם נשארים קרובים לכל החלטה שחשובה לכם, ורחוקים מכל מה שמכביד.',
      'וכשהערב מגיע, אתם פנויים לחיות אותו במלואו.',
    ],
    cta: 'בואו נכיר',
  },
  ...
  philosophy: {
    ...
    body: [
      'לפני שבוחרים אולם, צלם או עיצוב, ישנה שאלה אחת שקודמת לכולן: כיצד תרצו לזכור את הערב הזה.',
      'מה ירגישו האורחים שלכם ברגע שייכנסו.',
      'אילו רגעים יקרים לכם מכדי שיחלפו בין הפרטים.',
      'היכן נכון להשקיע, ומה אינו נתון לפשרה.',
      'מתוך התשובות האלה נבנית חתונה שהיא רק שלכם.',
    ],
  },
  ...
  value: {
    ...
    body: [
      ...
      'בכל רגע אתם יודעים מה נעשה עכשיו ומה השלב הבא.',
      'התקציב גלוי לעיניכם, הספקים מקבלים מענה, וההחלטות מתקבלות בזמן.',
      'הפרטים הקטנים אינם הופכים לדאגה גדולה בשבוע האחרון.',
      'ובערבים, אתם מדברים על החתונה עצמה, לא על משימותיה.',
      'כתובת אחת מלווה אתכם, מן הרגע הראשון ועד האחרון.',
    ],
  },
  ...
  about: {
    ...
    body: [
      'מאחורי כל הפקה עומדות יותר משמונה שנים ומאות אירועים, מחתונות שטח ועד ערבים מורכבים של מאות אורחים.',
      'השנים האלה לימדו אותנו דבר אחד פשוט: את הלחץ של היום הגדול אין מנהלים ברגע האמת. מונעים אותו מראש.',
      'אנחנו מקשיבים עד הסוף, בודקים את המספרים פעם נוספת, ואומרים את האמת גם כשהיא אינה נוחה.',
      'וכשמשהו משתנה ברגע האחרון, יש לצדכם מי שראה הכל ונשאר רגוע.',
    ],
  },
  ...
  dayOf: {
    title: 'וביום החתונה',
    body: [
      'ואז מגיע הרגע שבו התכנון נגמר והחגיגה מתחילה.',
      'האורחים נכנסים, המוזיקה עולה, והערב שחיכיתם לו קורה באמת.',
      'מאחורי הקלעים כבר ידוע מי הגיע, מה סוכם, ומה צריך לקרות בכל דקה.',
      'אתם לא אמורים להרגיש דבר מכל זה. זו בדיוק המלאכה.',
      'לכם נשאר רק לחגוג.',
    ],
  },
  ...
  academy: {
    ...
    body: [
      'יש זוגות שבוחרים להחזיק את ההפקה בידיים שלהם, ולעשות זאת כראוי.',
      'עבורם בנינו את הקורס הדיגיטלי: אותה שיטה שאנחנו עובדים לפיה, שלב אחר שלב.',
      'מהתקציב והלוקיישן ועד הספקים, החוזים ויום האירוע עצמו.',
      'אתם מפיקים לבד, אבל אינכם לבדכם.',
    ],
    cta: 'לקורס הדיגיטלי',
  },
  ...
  closing: {
    ...
    body: [
      'הכל מתחיל בשיחה אחת. חצי שעה של היכרות, בלי התחייבות.',
      'ספרו לנו היכן אתם נמצאים היום ואיזו חתונה אתם רואים בדמיונכם.',
      'אם נרגיש שנכון לצעוד יחד, נמשיך באותה הדרך. ואם לא, יצאתם עם סדר וכיוון.',
    ],
