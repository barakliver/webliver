...
export const privacyCopy = {
  ...
  short: [
    ...
    'רשימת האורחים שלכם, הקבצים שלכם והתקציב שלכם נראים לכם ולברק ליבר בלבד.',
  ...
  who:
    'ברק ליבר, הפקת חתונות ואירועים. לכל שאלה בנושא פרטיות אפשר לפנות ישירות בכתובת שלמטה, '
  ...
  whoSees: [
    'האזור שלכם נראה לכם ולברק ליבר. זוג אחד לא רואה אירוע של זוג אחר, וזה נאכף בבסיס '
...
export const termsCopy = {
  ...
  who:
    'ברק ליבר, הפקת חתונות ואירועים. האתר, האזור האישי והחנות מופעלים על ידו. כל פנייה '
