...
export const site: SiteCopy = {
  ...
  hero: {
    ...
    name: 'ברק ליור',
    body: [
      'ערב אחד בחיים, כל מי שאתם אוהבים נמצא במקום אחד.',
      'הערב הזה עובר מהר. את הדאגות אפשר לתת למישהו אחר.',
      'מהפגישה הראשונה ועד השיר האחרון, ברק מחזיק את התכנון, התקציב, הספקים וכל פרט קטן שבדרך.',
      'אתם נשארים קרובים לכל החלטה שחשובה לכם, ורחוקים מכל מה שמכביד.',
      'כדי שבערב עצמו תהיו במקום אחד בלבד. בפנים.',
    ],
    cta: 'בואו נכיר',
  },
  ...
  begin: {
    title: 'מאיפה מתחילים',
    steps: [
      { title: 'רואים את העבודות', body: 'תיק העבודות למטה. אל תחפשו יופי, תחפשו הרגשה.' },
      { title: 'בודקים את המספרים', body: 'מחשבון התקציב נותן סדר גודל בדקה, בלי להשאיר פרטים.' },
      { title: 'קובעים פגישת היכרות', body: 'חצי שעה עם ברק, בלי התחייבות. אחריה תדעו אם ממשיכים יחד.' },
    ],
  },
  ...
  philosophy: {
    ...
    body: [
      'לפני שבוחרים מקום, צלם או עיצוב, עוצרים לשאלה אחת: איך אתם רוצים לזכור את הערב הזה.',
      'מה ירגישו האנשים שלכם ברגע שהם נכנסים.',
      'איזה רגע אסור שיברח לכם בין הפרטים.',
      'איפה נכון להשקיע, ועל מה אין ויתורים.',
      'מהתשובות האלה נבנית חתונה שאי אפשר להעתיק, כי היא מתחילה מכם.',
    ],
  },
  ...
  value: {
    ...
    body: [
      'שקט זה לא שאין מה לעשות. שקט זה לדעת שמישהו כבר עושה.',
      'אתם יודעים בכל רגע מה קורה עכשיו ומה השלב הבא.',
      'התקציב מול העיניים, הספקים מקבלים תשובות, ההחלטות מתקבלות בזמן.',
      'הדברים הקטנים לא הופכים לבעיה גדולה שבוע לפני החתונה.',
      'ובערב, כשאתם לבד, אתם מדברים על החתונה. לא על המשימות שלה.',
      'כתובת אחת, מהרגע הראשון ועד האחרון.',
    ],
  },
  ...
  about: {
    ...
    body: [
      'יותר משמונה שנים ומאות אירועים, מחתונות שטח ועד ערבים מורכבים של מאות אורחים, לימדו את ברק דבר אחד פשוט: את הלחץ של היום הזה לא מנהלים. מונעים אותו מראש.',
      'הוא האדם שמקשיב עד הסוף, בודק שוב את המספרים, ואומר לכם את האמת גם כשהיא פחות נעימה.',
      'וכשמשהו זז ברגע האחרון, והוא תמיד זז, יש לידכם מישהו שכבר ראה הכל ונשאר רגוע.',
      'כי ביום הכי חשוב שלכם, מגיע לכם אדם שאפשר פשוט לסמוך עליו.',
    ],
  },

  work: {
    title: 'עבודות אחרונות',
    sub: 'שמונה רגעים משנה אחת של חתונות. מאחורי כל אחד מהם עומדים חודשים של עבודה שקטה.',
  },

  dayOf: {
    title: 'וביום החתונה',
    body: [
      'ואז מגיע הרגע שבו מפסיקים לתכנן.',
      'האנשים שלכם נכנסים. המוזיקה עולה. מישהי בוכה עוד לפני החופה.',
      'מאחורי הקלעים ברק כבר יודע מי הגיע, מה סוכם, ומה צריך לקרות בכל דקה.',
      'אתם לא תראו את זה קורה. זאת בדיוק הכוונה.',
      'אתם תהיו עסוקים בלרקוד.',
    ],
  },
  ...
  academy: {
    ...
    body: [
      'יש זוגות שרוצים להחזיק את ההפקה בידיים שלהם, ולעשות את זה כמו שצריך.',
      'בשבילם ברק בנה את הקורס הדיגיטלי: אותה שיטה שהוא עובד לפיה, שלב אחרי שלב.',
      'מהתקציב והלוקיישן ועד הספקים, החוזים ויום האירוע עצמו.',
      'אתם מפיקים לבד. אתם לא לבד.',
    ],
    cta: 'לקורס הדיגיטלי',
  },
  ...
  closing: {
    ...
    body: [
      'חצי שעה, בלי התחייבות.',
      'ספרו לברק איפה אתם היום ואיזו חתונה אתם רואים בעיניים.',
      'אם זה מרגיש נכון, ממשיכים יחד. ואם לא, יצאתם עם סדר בראש.',
    ],
  ...
  budget: {
    ...
    closing: 'רוצים לעבור על המספרים האמיתיים עם ברק? חצי שעה ביומן, בלי התחייבות.',
  },

  lead: {
    title: 'נעים להכיר',
    sub: 'משאירים פרטים, וברק חוזר אליכם בדרך כלל תוך יום עסקים. עונה לכם בן אדם, לא מערכת.',
    fields: {
      name: 'שם מלא',
      phone: 'טלפון',
      email: 'אימייל',
    ...
    sending: 'שולח',
    okTitle: 'תודה, קיבלנו',
    okBody: 'הפרטים הגיעו ישירות לברק. הוא יחזור אליכם בדרך כלל תוך יום עסקים.',
  },
...
export const termsCopy = {
  ...
  scope: [
    ...
    ['האזור האישי',
     ...
     + 'הלוז, הקבצים והשיחה עם ברק.'],
    ['החנות', 'מוצרים ושירותים שאפשר לבקש דרך האתר. הפרטים בהמשך.'],
    ['ההפקה עצמה',
     'העבודה שברק מבצע. היא נקבעת בהסכם שנחתם בין הצדדים ולא בעמוד הזה.'],
  ],
  ...
  content: [
    ...
    'אנחנו מקבלים רשות אחת ומצומצמת: להחזיק את החומר, להציג אותו לכם ולברק, ולהשתמש בו '
  ...
  shop: [
    ...
    + 'צעד נוסף.',
    'הזמנה שנשלחת מהחנות היא בקשה שמגיעה לברק, לא רכישה. שום אמצעי תשלום לא נמסר כאן '
    + 'ושום כרטיס לא נטען.',
