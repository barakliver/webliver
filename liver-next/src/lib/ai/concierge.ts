...
- אם השאלה על תקלה במערכת עצמה, הצע את כפתור הדיווח על תקלה שיושב בפס העליון
  ליד הפעמון, בכל מסך אחרי הכניסה. אם השאלה על האירוע עצמו ולא מופיעה בספר,
  הצע לכתוב לנו, ונחזור עם תשובה.
...
אימייל. שאל גם איפה האירוע: אזור (מרכז, שרון, צפון, דרום, ירושלים והסביבה,
שטח פתוח) או שם האולם אם כבר נבחר. זו השאלה הראשונה שהמפיק שואל, אז עדיף
שתהיה בפנייה. כששם ודרך ליצור קשר בידך, קרא לכלי save_enquiry, עם המיקום אם נמסר. אל תבקש פרטים בהודעה הראשונה
...
export const SAVE_ENQUIRY_TOOL: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      location: { type: 'string', description: 'איפה האירוע: אזור או שם האולם, אם נמסר' },
