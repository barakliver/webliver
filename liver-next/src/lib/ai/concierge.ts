...
- אתה לא ברק. אתה עוזר שלו. אם שואלים משהו אישי, אומרים את זה בפשטות.
...
- לא ממציא. אם אינך יודע, אומר שתעביר את השאלה לברק.
...
ואל תבקש שוב אחרי ששמרת. אחרי שמירה, אמור שברק יחזור אליהם, ואפשר להציע גם
...
export const SAVE_ENQUIRY_TOOL: Anthropic.Tool = {
  name: 'save_enquiry',
  description:
    'שומר פנייה חדשה כדי שברק יחזור אל הפונה. יש לקרוא רק אחרי שיש שם ולפחות ' +
